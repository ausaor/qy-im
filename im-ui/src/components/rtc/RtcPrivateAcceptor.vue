<template>
  <div v-show="isShow" class="chat-video-acceptor">
    ...
    <div class="acceptor-btn-group">
      <div class="icon iconfont icon-icon_phone_accept_hover accept" @click="accpet()" title="接受"></div>
      <div class="icon iconfont icon-icon_phone_reject_nor reject" @click="reject()" title="拒绝"></div>
    </div>
  </div>
</template>
