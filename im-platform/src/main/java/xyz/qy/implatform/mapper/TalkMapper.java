...
public interface TalkMapper extends BaseMapper<Talk> {
     ...
     * @return 动态列表
     */
    Page<Talk> pageQueryMyCharacterTalkList(@Param("page") Page<Object> page, @Param("queryDTO") TalkQueryDTO queryDTO);
     ...
     * @return 动态列表
     */
    Page<Talk> pageQueryFollowCharactersTalkList(@Param("page") Page<Object> page, @Param("queryDTO") TalkQueryDTO queryDTO);
}
