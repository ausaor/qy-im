...
@Slf4j
@Component
public class PullShortVideoMessageTask extends AbstractPullMessageTask {
    @Resource
    ...
    public void pullMessage() {
        // 从redis拉取未读消息
        String key = String.join(":", IMRedisKey.IM_MESSAGE_SHORT_VIDEO_QUEUE, IMServerGroup.serverId + "");
        ...
        while (!Objects.isNull(jsonObject)) {
            ...
            AbstractMessageProcessor processor = ProcessorFactory.createProcessor(IMCmdType.SHORT_VIDEO_MESSAGE);
