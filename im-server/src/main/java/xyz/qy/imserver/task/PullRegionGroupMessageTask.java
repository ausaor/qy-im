...
@Slf4j
@Component
public class PullRegionGroupMessageTask extends AbstractPullMessageTask {
    @Resource
    ...
    public void pullMessage() {
        // 从redis拉取未读消息
        String key = String.join(":", IMRedisKey.IM_MESSAGE_REGION_GROUP_QUEUE, IMServerGroup.serverId + "");
        ...
        while (!Objects.isNull(jsonObject)) {
            ...
            AbstractMessageProcessor processor = ProcessorFactory.createProcessor(IMCmdType.REGION_GROUP_MESSAGE);
