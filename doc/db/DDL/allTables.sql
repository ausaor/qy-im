...
(
    ...
    send_user_avatar varchar(1000)                           null comment '发送用户头像',
    is_template    tinyint(1)    default 0                   not null comment '是否模板角色消息',
...
(
    ...
    top_reply_comment_id    bigint           null comment '顶级回复的评论id',
