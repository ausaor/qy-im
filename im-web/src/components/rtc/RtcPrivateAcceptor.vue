<template>
  <div class="rtc-private-acceptor">
    ...
    <div class="btn-group">
      <div class="icon iconfont icon-icon_phone_accept_hover accept" @click="$emit('accept')" title="接受"></div>
      <div class="icon iconfont icon-icon_phone_reject_nor reject" @click="$emit('reject')" title="拒绝"></div>
    </div>
  </div>
</template>
